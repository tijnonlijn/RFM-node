...
// pin mappings; comment/uncomment the one matching your node

// Pin mapping  for https://www.thethingsnetwork.org/labs/story/build-the-cheapest-possible-node-yourself
...
// Pin mapping for douglarue's pcb
/*
const lmic_pinmap lmic_pins = {
.nss = 10,
...
void loop() {
        ...
        Serial.println(F("Finished waiting.. entering sleep"));
        ...
        Serial.println(F("Finished sleeping.. wake up"));   
