...
static const PROGMEM u1_t NWKSKEY[16] = { 0xC0, 0x71, 0xF6, 0x7E, 0x32, 0x7A, 0x74, 0x13, 0x0B, 0x48, 0xFD, 0x8B, 0xXX, 0xXX, 0xXX, 0xXX };

// LoRaWAN AppSKey, application session key, 16 bytes  (from staging.thethingsnetwork.org)
static const u1_t PROGMEM APPSKEY[16] = { 0x32, 0x45, 0x5C, 0x14, 0xFC, 0x3C, 0xCF, 0xF2, 0xF0, 0x08, 0x7A, 0x09, 0xXX, 0xXX, 0xXX, 0xXX };
