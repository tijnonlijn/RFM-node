...
static const u4_t DEVADDR = 0xXXXXXXXX ; // <-- Change this address for every node!  // PIR node
...
// MQ161014 start pir merge
// MQ161014 end pir merge
...
// MQ161014 start pir merge
  ...
  for(int i = 0; i < calibrationTime; i++){
      // visual feedback sensor is calibrating
      #ifdef DEBUG
        Serial.print(F("."));
      #endif
      delay(300);
