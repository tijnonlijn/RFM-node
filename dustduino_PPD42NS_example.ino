...
// network initially.
static const PROGMEM u1_t NWKSKEY[16] = [insert your key here] ;

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the prototype TTN
// network initially.
static const u1_t PROGMEM APPSKEY[16] = [insert your key here];

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
static const u4_t DEVADDR = [insert your address here];
